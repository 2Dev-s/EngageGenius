    ...
    <UserLayout>
        ...
        <form  class="flex flex-1 flex-col gap-4" @submit.prevent="submit">
            ...
            <div class="flex justify-end gap-4">
                <button class="px-6 py-2 bg-blue-700 rounded-md" @click="submitForm"  type="button"> Generate Campain</button>
                <button class="px-6 py-2 bg-blue-700 rounded-md" @click="submitForm" type="button"> Save Campain</button>
            </div>
        </div>
    </UserLayout>
</template>
...
/* import CreateFrom from '@/Components/Campains/FormCard.vue'; */
