        ...
        <div class="flex flex-col gap-4 h-full">
            <div class="flex flex-col items-center gap-4 mt-5">
                ...
                <div class="flex w-full gap-5  justify-center items-center flex-wrap ">
                    <Chips class="dark:bg-gray-800 dark:border-gray-700 " :pt="{
                        token: {
                    ...
                    <Dropdown :options="[]" optionLabel="title" optionValue="id" v-model="campain"
                    ...
                    <IconField iconPosition="left" :pt="{
                        root: ({ props }) => ({
                            class: [
                                'relative',
                                '[&>input]:w-full',
                        ...
                        <InputText placeholder="Product Data"
                            class="pl-10 w-full dark:bg-gray-800 dark:border-gray-700" />
                    </IconField>
                    <SelectButton :options="endedFilterOptions" optionLabel="label" optionValue="value"
                        aria-labelledby="basic" class="rounded-md h-12" />
                    <span>
                        <InputText v-model.number="campainDiscount" class="w-full" />
                        <Slider v-model="campainDiscount" />
                    </span>
                            ...
                            <div class="flex flex-col items-center justify-center gap-2">
                                <div v-for="(item, index) in slotProps.items" :key="index"
                                    ...
                                    <div class="flex items-center col-span-1">
                                        <SpeedDial :radius="75" type="semi-circle"
