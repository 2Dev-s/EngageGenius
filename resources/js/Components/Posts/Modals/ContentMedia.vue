            ...
            <div class="flex flex-col gap-4">
                ...
                <span class="flex flex-col justify-end items-end">
                    <textarea placeholder="Image Data" type="text" v-model="imageData"
                        class="block w-full p-4 h-40 max-h-40 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </textarea>
                ...
                <div
                    class="h-96 w-full gap-4 flex-wrap p-4 items-center justify-start bg-gray-50 dark:bg-gray-700 border border-gray-30  dark:border-gray-600 dark:placeholder-gray-400 rounded-lg overflow-y-auto grid grid-cols-3">
...
export default {
    ...
    methods: {
        ...
        generate() {
            ...
            axios.get("openai.post.create", { params })
                .then(response => {
